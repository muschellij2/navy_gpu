...
# FLEXCONN
The [FLEXCONN](https://www.nitrc.org/projects/flexconn) software v1.1 from  @roy2018multipl is located at https://www.nitrc.org/projects/flexconn.  The `README.txt` indicates to install the necessary requirements:
...
library(neurobase)
imgs = check_nifti(dl)
imgs = lapply(imgs, mask_img, mask = imgs$brain_mask)
```
